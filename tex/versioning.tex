...
Version is typically identified by decimal number. The number is typically just major digit for every of the version unit. For example the API can be inversion \emph{v2} and can contain a service with version \emph{v1} and \emph{v2}, this service versions can have a method of versions \emph{v1} and \emph{v2}.
