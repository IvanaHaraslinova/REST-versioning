...
\begin{enumerate}
  ...
  The stage designs the service contracts. For every service candidate it is considered a technical contract, in case of REST services (described in chapter \ref{chap:rest}) it is inevitable to think of HTTP method usage, resource identifiers and header parameters.
