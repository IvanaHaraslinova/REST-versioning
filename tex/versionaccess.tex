...
Here is an exapmle of the versioning approaches which are used by well known web applications with REST API. \cite{website:restapi-example}
\begin{center}
\begin{tabular}{lll}
API NAME & VERSIONING &	EXAMPLE \\ \hline

Twillo & date in URI \\
Twitter &	URI \\
Atlassian & URI \\
Google Search	& URI	\\
Github API & URI/Media Type in v3 & \begin{tabular}[c]{@{}l@{}}Intention is to remove versioning in favour \\ of hypermedia – current application/vnd.github.v3\end{tabular} \\
...
Foursquare	& URI	& https://api.foursquare.com/v2/venues/40a55d80f964a52020f31ee3?oauth \\
\begin{tabular}{@{}l@{}}Google data API\\ (youtube/spreadsheets/\\ others)\end{tabular}	& \begin{tabular}[c]{@{}l@{}}URI parameter \\ or custom header\end{tabular} & "GData-Version: X.0" or "v=X.0" \\
